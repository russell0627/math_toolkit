                  ...
                  children: [
                    ...
                    GridView.count(
                      ...
                      children: [
                        ...
                        _MenuCard(
                          title: "ACCELERATION",
                          subtitle: "VELOCITY FLUX AUDITOR (ACC-01)",
                          icon: Icons.speed_outlined,
                          accentColor: Colors.amberAccent,
                          onTap: () => context.pushNamed(AppRoute.acceleration.name),
                        ),
                        _MenuCard(
                          title: "EFFICIENCY",
                          subtitle: "THERMODYNAMIC AUDITOR (EFF-01)",
                          icon: Icons.bolt_outlined,
                          accentColor: Colors.amberAccent,
                          onTap: () => context.pushNamed(AppRoute.efficiency.name),
                        ),
                      ],
                    ),
                    const SizedBox(height: 24),
