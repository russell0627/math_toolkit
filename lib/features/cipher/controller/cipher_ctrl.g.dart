...
final class CipherCtrlProvider extends $NotifierProvider<CipherCtrl, CipherState> {
...
abstract class _$CipherCtrl extends $Notifier<CipherState> {
  ...
  void runBuild() {
    ...
    final element =
        ref.element as $ClassProviderElement<AnyNotifier<CipherState, CipherState>, CipherState, Object?, Object?>;
