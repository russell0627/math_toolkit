...
class TriangleSolverScreen extends ConsumerWidget {
  const TriangleSolverScreen({super.key});
        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              const Expanded(child: TriangleView()),
            ],
          ),
        ),
      ),
  ...
  Widget _buildTopConsole(BuildContext context, TriangleSolverCtrl ctrl, dynamic styles) {
    return Container(
